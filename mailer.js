	...
	mailTargetAudience:function(reqBody){
		return new Promise(function(resolve, reject){
			...
			var mailOptions = {
			  ...
			  //to:'wilfredf@hexaware.com,saisub@hexaware.com,omprakashr@hexaware.com,rahulp@hexaware.com,rahulp2@hexaware.com,ravindrag@hexaware.com,arjunb@hexaware.com,harikrishnanv@hexaware.com,KarlD@hexaware.com,ravindra.gharpure@gmail.com',
...
mailPackageDetails:function(){
	return new Promise(function(resolve, reject){
		...
		readModuleFile('./mail.html').then((words)=> {
			...
			var mailOptions = {
			from: 'hexatestmailer@gmail.com',
			to: 'harikrishnanv@hexaware.com,haritechno92@gmail.com,39754.hexaware@gmail.com',
			//to:'wilfredf@hexaware.com,saisub@hexaware.com,omprakashr@hexaware.com,rahulp@hexaware.com,rahulp2@hexaware.com,ravindrag@hexaware.com,arjunb@hexaware.com,harikrishnanv@hexaware.com,KarlD@hexaware.com,ravindra.gharpure@gmail.com',
